...
import { Text, StyleSheet, View, ImageBackground,TouchableOpacity, SafeAreaView, Platform, StatusBar, ScrollView } from "react-native";
    ...
    if (!this.state.fontsLoaded) {
     ...
     return(
       ...
       <SafeAreaView style={styles.droidSafeArea} />
        <Text style={styles.headingText}>Braggs Quizz </Text> 
